              ...
              return (
                      <form onSubmit={this.handleSubmit.bind(this)} noValidate>
                              <div className="[ form-row ][ align-items-center ][ mt-5 ]">
                                  ...
                                  <div className="[ col-sm-12 ][ my-1 ]">
                                      <div className="[ input-group ]">
                                          <div className="[ input-group-prepend ]">
                                              <div className="[ input-group-text ]"><FontAwesomeIcon icon={faUser} color="#FF6B4C" size="lg" /></div>
                                          </div>
                                  ...
                                  <div className="[ input-group ]">
                                      <div className="[ input-group-prepend ]">
                                          <div className="[ input-group-text ]"><FontAwesomeIcon icon={faAt} color="#FF6B4C" size="lg"  /></div>
                                      </div>
                                  ...
                                  <div className="[ col-sm-12 ][ my-1 ]">
                                      <div className="[ input-group ]">
                                          <div className="[ input-group-prepend ]">
                                              <div className="[ input-group-text ]"><FontAwesomeIcon icon={faPhone} color="#FF6B4C" size="lg"  /></div>
                                          </div>
                                  ...
                                  <div className="[ col-sm-12 ][ my-1 ]">
                                      <div className="[ input-group ]">
                                          <div className="[ input-group-prepend ]">
                                              <div className="[ input-group-text ]"><FontAwesomeIcon icon={faCommentAlt} color="#FF6B4C" size="lg"  /></div>
                                          </div>
                                  ...
                                  <button type="submit" className="[ btn btn-orange btn-contact ]">Submit</button>
                                  </div>
                              </div>
                          </form>
              );
